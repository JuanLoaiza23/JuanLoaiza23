...
public class PrincipalMenu {
    ...
    public void validateOptions() {
        //Options
        WebElement buttonWhyUTest = webDriver.findElement(By.linkText("Why uTest"));
        WebElement buttonAboutUs = webDriver.findElement(By.linkText("About Us"));
        WebElement buttonProjects = webDriver.findElement(By.linkText("Projects"));
        WebElement buttonLogin = webDriver.findElement(By.linkText("Log In"));
        WebElement buttonContactUs = webDriver.findElement(By.linkText("Contact Us"));

        Assert.assertTrue(buttonWhyUTest.isDisplayed());
        Assert.assertTrue(buttonAboutUs.isDisplayed());
        Assert.assertTrue(buttonProjects.isDisplayed());
        Assert.assertTrue(buttonLogin.isDisplayed());
        Assert.assertTrue(buttonContactUs.isDisplayed());
    }

    @Test
    public void getIntoToOptionWhyUTest(){

       // ((JavascriptExecutor)webDriver).executeScript("window.open()");
        webDriver.findElement(By.linkText("Why uTest")).click();

        WebElement text=  webDriver.findElement(By.className("why-utest__header-heading"));
        WebDriverWait wait = new WebDriverWait(webDriver, WAIT_SECONDS);
        wait.until(ExpectedConditions.elementToBeClickable(text));
        Assert.assertEquals("Why uTest?",text.getAttribute("innerText"));
    }
    @Test
